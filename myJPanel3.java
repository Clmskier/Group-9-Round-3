...
public class myJPanel3 extends JPanel implements KeyListener, ActionListener {
    ...
    public myJPanel3(myJPanel imjp) {
        super();
        mjp = imjp;
        setLayout(null);
...
//        gameOver = new GameOverPanel();
    ...
    myJPanel3(ActionListener aThis) {
